...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    const ImColor active_col_CRIMSON = ImColor(203, 114, 255, 255);
    const ImColor active_col_SMV = ImColor(255, 0, 127, 255);
    const ImColor active_col_UCHIHA = ImColor(160, 21, 20, 255);

    static const ImColor active_col = active_col_SMV;
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
   ...
   // Render filled grab
    ...
    {
        const ImU32 grab_col = GetColorU32(ImGuiCol_SliderGrab);
